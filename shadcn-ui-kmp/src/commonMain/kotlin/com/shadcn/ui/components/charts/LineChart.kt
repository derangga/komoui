 ...
 * true. When [showTooltip] is true, press-and-drag horizontally to scrub.
 */
@Composable
fun LineChart(
        ...
        Box(
            ...
            Canvas(
                ...
                clipRect(
                    ...
                    series.forEach { s ->
                        val points = seriesPositions(s.points.map { it.y }, plotRect, domain, slotWidth)
                ...
                scrub.index?.let { idx ->
                    ...
                    series.forEach { s ->
                        ...
                        val cy = plotRect.bottom - ((p.y - domain.start) / span) * plotRect.height
